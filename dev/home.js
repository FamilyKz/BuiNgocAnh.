jQuery(document).ready(function(){
    ...
    $("#to_BF img").mouseenter(function(){
        ...
        setTimeout(() => {           
            window.open('https://familykz.github.io/DaoLoc','_blank');  
        },600)                 
...
// 
    $("#button_to_facebook").mouseenter(function(){
        ...
        setTimeout(() => {           
            window.open('https://www.facebook.com/profile.php?id=100055145220579','_blank');  
        },600)    
    }).mouseleave(function(){
        $(this).css({ 
...
//    
    ...
    // $("#Wallpaper video").on("timeupdate",function(){
    //     if(this.duration-this.currentTime <= 3){
    //         // $(this).css({
    //         //     "opacity":"0%",
